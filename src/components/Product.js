...
function Product({ product }) {
  ...
  return (
    <>
      ...
      />
      <div>
        <p className="mt-4 text-gray-600 text-center font-bold font-sans text-lg">
          {product.title}
        </p>
        <p className="mt-4 text-center truncate text-sm text-gray-400 italic">
          {product.description}
        </p>
        <div className="flex justify-between">
          <div className="flex m-6">
            <img src={up} alt="basePrice" className="mr-4" />
            <p className="">{product.basePrice} €</p>
          </div>
          <div className="flex m-6">
            <img src={down} alt="salePrice" className="mr-4" />
        ...
        <div className="flex justify-between mb-6">
          <button
            type="button"
            className="ml-2 px-2 py-3 bg-blue-600 hover:bg-blue-800 rounded-md text-white outline-none focus:ring-4 shadow-lg transform transition-transform flex text-xs lg:text-sm"
          >
            <svg
              width="20px"
              height="20px"
          ...
          <button
            ...
            className="mr-2 px-4 py-3 bg-red-600 hover:bg-red-800 rounded-md text-white outline-none focus:ring-4 shadow-lg transform transition-transform flex text-xs lg:text-sm"
          >
            <svg
              width="20px"
              height="20px"
